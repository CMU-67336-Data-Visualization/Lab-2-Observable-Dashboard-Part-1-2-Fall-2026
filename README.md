...
| File | Purpose |
|---|---|
| `observable-lab.ipynb` | **Part 1** — the challenges above (Getting Started through Deployment) |
| `observable-lab-part2.ipynb` | **Part 2** — Observable Dashboard with AI Assistance |
